import { X, UserCircle, Eye, EyeOff, Phone, Mail, ShieldCheck, Hash } from "lucide-react";
import { useState } from "react";

export default function CustomerForm({ open, onClose, onSubmit, editing }) {
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto slide-up">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-neutral-600">
                                {editing ? "Chỉnh sửa thông tin khách hàng" : "Tạo khách hàng mới trong hệ thống"}
                            </p>
                        </div>
                    </div>
                    <button
                ...
                <div className="p-6 space-y-6">
                    <div className="space-y-4">
                        <h3 className="text-sm font-semibold text-neutral-900 uppercase tracking-wider">Thông tin khách hàng</h3>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label className="block text-sm font-medium text-neutral-700 mb-2">Mã khách hàng</label>
                            ...
                            <div className="md:col-span-2">
                                ...
                                <div className="relative">
                                    <UserCircle className="absolute left-3 top-1/2 transform -translate-y-1/2 text-neutral-400" size={18} />
                                    <input
                                        type="text"
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setForm({ ...form, kh_password: e.target.value })}
                            ...
                            <div className="md:col-span-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        readOnly
                                        disabled
                                        className="w-full pl-10 pr-4 py-3 bg-neutral-50 border border-neutral-200 rounded-xl text-neutral-700 disabled:opacity-100 cursor-not-allowed"
                                    />
                                    <input
                                        type="hidden"
                                        value={form.kh_role || "ROLE_CUSTOMER"}
                                        readOnly
                                    />
                                </div>
                            </div>
                ...
                <div className="flex items-center justify-end gap-3 p-6 border-t border-neutral-100 bg-neutral-50 rounded-b-2xl">
                    ...
                    >
                        <UserCircle size={18} />
                        {editing ? "Cập nhật" : "Thêm khách hàng"}
                    </button>
                </div>
            </div>
        </div>
