                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-neutral-900">
                                {form.nv_id ? "Cập nhật nhân viên" : "Thêm nhân viên mới"}
                            </h2>
                            <p className="text-sm text-neutral-600">
                                {form.nv_id ? "Chỉnh sửa thông tin nhân viên" : "Tạo nhân viên mới trong hệ thống"}
                            </p>
                        </div>
                    </div>
                    <button
                            ...
                            <div className="md:col-span-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        value={form.nv_name}
                                        onChange={e =>
                                            setForm({ ...form, nv_name: e.target.value })
                                        }
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        value={form.nv_phone}
                                        onChange={e =>
                                            setForm({ ...form, nv_phone: e.target.value })
                                        }
                                        className="w-full pl-10 pr-4 py-3 bg-white border border-neutral-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-200"
                                        required
                                    />
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        value={form.nv_mail}
                                        onChange={e =>
                                            setForm({ ...form, nv_mail: e.target.value })
                                        }
                                        className="w-full pl-10 pr-4 py-3 bg-white border border-neutral-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-200"
                                        required
                                    />
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        value={form.nv_birth}
                                        onChange={e =>
                                            setForm({ ...form, nv_birth: e.target.value })
                                        }
                                        className="w-full pl-10 pr-4 py-3 bg-white border border-neutral-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-200"
                                    />
                                </div>
                            ...
                            <div className="md:col-span-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onChange={e =>
                                            setForm({ ...form, nv_address: e.target.value })
                                        }
                                        className="w-full pl-10 pr-4 py-3 bg-white border border-neutral-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-200"
                                    />
                                </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <select
                                        value={form.nv_role}
                                        onChange={e =>
                                            setForm({ ...form, nv_role: e.target.value })
                                        }
