        ...
        <div className="auth-right dark:bg-background-dark">
          <div className="max-w-[400px] mx-auto w-full">
            ...
            <div className="mb-10 text-left">
              <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-3 title">
                Đổi mật khẩu
              </h2>
            ...
            <div className="mt-10 pt-8 border-t border-gray-100 dark:border-gray-800 text-center">
              <a
                className="text-sm font-bold text-gray-500 dark:text-gray-400 hover:text-primary dark:hover:text-blue-400 transition-colors flex items-center justify-center gap-2"
                href="#"
              >
